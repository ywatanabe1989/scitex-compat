...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-compat/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-compat` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-compat.git
cd scitex-compat
pip install -e ".[dev]"
```
