...
# (project=scitex-compat, owner=ywatanabe1989, repo=scitex-compat,
...
TMPDIR="/tmp/publish-scitex_compat-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-compat dist/* uploaded to PyPI via manual OIDC trusted publishing"
